...
var colors = _interopRequireWildcard(_d3ScaleChromatic);
...
var PieChart = function (_DataWidget) {
   _inherits(PieChart, _DataWidget);

   function PieChart(element) {
      _classCallCheck(this, PieChart);

      var _this2 = _possibleConstructorReturn(this, (PieChart.__proto__ || Object.getPrototypeOf(PieChart)).call(this));
   ...
   _createClass(PieChart, [{
      ...
      value: function listen() {
         ...
         var selectors = this.element.querySelectorAll('.gw-selector');
      ...
      value: function getData() {
         ...
         this.fetch('' + this.getUrl()).then(function (response) {
            _this4.searchPlayer(response);
         }).catch(function (err) {
            return _this4.handleErrors(err);
         });
      }
   }, {
      key: 'handleErrors',
      ...
      key: 'searchPlayer',
      value: function searchPlayer(res) {
         ...
         try {
            for (var _iterator2 = res[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
               ...
               if (player.Name.toLowerCase().includes(searchTerm.toLowerCase())) {
                  var dataset = this.getSchema(player);
      ...
      value: function getSearchTerm() {
         ...
         var str = queryStringObject.player.split("+");
         var newStr = '';
      ...
      key: 'getSchema',
      value: function getSchema(player) {
         var points = {
            Goals: 15,
            Assists: 7,
            ShotsOnTarget: 5,
         ...
         return [{ label: "Goals", count: player.Goals * points.Goals, enabled: true }, { label: "Assists", count: player.Assists * points.Assists, enabled: true }, { label: "ShotsOnTarget", count: player.ShotsOnTarget * points.ShotsOnTarget, enabled: true }, { label: "ChancesCreated", count: player.ChancesCreated * points.ChancesCreated, enabled: true }, { label: "TacklesWon", count: player.TacklesWon * points.TacklesWon, enabled: true }, { label: "ShotsBlocked", count: player.ShotsBlocked * points.ShotsBlocked, enabled: true }, { label: "Interceptions", count: player.Interceptions * points.Interceptions, enabled: true }, { label: "Clearances", count: player.Clearances * points.Clearances, enabled: true }, { label: "FoulsWon", count: player.FoulsWon * points.FoulsWon, enabled: true }, { label: "Passes", count: player.Passes * points.Passes, enabled: true }];
      }
   }, {
      key: 'getLabel',
      value: function getLabel(label) {
         var arr = label.split(/(?=[A-Z])/);
         var newLabel = '';
...
},{"../helpers/data":2,"../helpers/query-string-parser":5,"d3":307,"d3-scale-chromatic":306}],2:[function(require,module,exports){
'use strict';
...
var DataWidget = function () {
  ...
  _createClass(DataWidget, [{
    ...
    value: function fetch(url) {
      ...
      return (0, _fetch3.default)(url || this.getUrl(), Object.assign({
...
},{"./fetch":4}],3:[function(require,module,exports){
"use strict";
...
document.addEventListener('DOMContentLoaded', function () {
  _factory2.default.attach('.top-section', _matches2.default);
  _factory2.default.attach('.gw-stats', _stats2.default);
  _factory2.default.attach('.d3', _d2.default);
});

},{"./d3":1,"./helpers/factory":3,"./matches":7,"./stats":8,"babel-polyfill":9,"ima.js-babel6-polyfill":308,"whatwg-fetch":312}],7:[function(require,module,exports){
'use strict';
...
var Matches = function (_DataWidget) {
  _inherits(Matches, _DataWidget);
  ...
  _createClass(Matches, [{
    ...
    key: 'getGameWeek',
    value: function getGameWeek() {
      var gameweek = this.element.querySelector('.gw').innerHTML;
      return '?matchday=' + gameweek;
    }
  }, {
    key: 'getCompetition',
    value: function getCompetition() {
      var comp = this.element.querySelector('.comp').innerHTML;
      return comp;
    }
  }, {
    key: 'getHeaders',
    value: function getHeaders() {
      var matchHeaders = new Headers();
    ...
    value: function getData() {
      ...
      this.fetch('' + this.getUrl() + this.getGameWeek()).then(function (response) {
        _this2.renderTodayFixtures(response.fixtures);
      }).catch(function (err) {
    ...
    value: function getTemplate() {
      var match = this.element.querySelector('.fixture');
      match.parentNode.removeChild(match);

      return match;
    }
  }, {
    key: 'renderTodayFixtures',
    value: function renderTodayFixtures(fixtures) {
      var matchTemplate = this.getTemplate();
      ...
      try {
        for (var _iterator = fixtures[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          var match = matchTemplate.cloneNode(true);
          var kickoff = new _moment2.default(fixture.date);
...
},{"../helpers/data":2,"../helpers/fetch":4,"moment":309}],8:[function(require,module,exports){
'use strict';
...
var Stats = function (_DataWidget) {
  _inherits(Stats, _DataWidget);
  ...
  function Stats(element) {
    ...
    _this.element = element;
    _this.gameweek = _this.element.dataset.gameweek;
  ...
  _createClass(Stats, [{
    ...
    value: function getData() {
      ...
      this.fetch('' + this.getUrl() + this.gameweek).then(function (response) {
        _this2.renderStats(response);
      }).catch(function (err) {
        return _this2.handleErrors(err);
      });
    }
    ...
    key: 'getTemplate',
    value: function getTemplate() {
      var row = this.element.querySelector('.row-data');
    ...
    value: function renderStats(stats) {
      var rowTemplate = this.getTemplate();
      var frag = document.createDocumentFragment();
      var body = this.element.querySelector('.stat-body');
...
},{"../helpers/data":2,"../helpers/fetch":4,"moment":309}],9:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/fn/regexp/escape":10,"core-js/shim":303,"regenerator-runtime/runtime":311}],10:[function(require,module,exports){
...
},{"d3-color":304}],306:[function(require,module,exports){
// https://d3js.org/d3-scale-chromatic/ Version 1.0.2. Copyright 2016 Mike Bostock.
(function (global, factory) {
...
},{"d3-interpolate":305}],307:[function(require,module,exports){
